...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=1.0\textwidth]{chapter7/skala_antenna_cad_drawing.png}
    \caption[CAD drawing of a SKALA-v2 radio antenna.]{A CAD drawing of a SKALA-v2 radio antenna.}
    \label{fig:skala_cad_drawing}
\end{figure}

The metal arms of the LNAs are connected directly to the antenna metal of each antenna arm and fixed in place with screws to ensure adequate contact between the antenna and LNA.
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=1.0\textwidth]{chapter7/LNAs_in_lab.jpg}
    \caption[Picture of a SKALA-v2 antenna trumpet with visible LNA.]{A picture of the SKALA-v2 antenna trumpet taken during the LNA assembly at the main Auger observatory campus in Malarg\"ue.}
...
The main DAQ responsibilities are handled by TAXI-v3.2, an updated version of the principal electronics board developed for the TAXI project.
Two additional electronics boards connect to the TAXI-v3.2 board to complete the DAQ system for each station of SKALA antennas.
