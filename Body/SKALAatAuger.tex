...
Two additional electronics boards connect to the TAXI-v3.2 board to complete the DAQ system.
...
Each radioTad board connects to a single SKALA antenna and has two polarizations, labeled positive and negative, for the two antenna LNAs.
...
Inside the TAXI housing, the radioTads are covered with a custom sized aluminum cover to prevent bi-directional RFI leakage.
