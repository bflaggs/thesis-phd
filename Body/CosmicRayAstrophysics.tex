...
The given energies of the ankle, instep, and cutoff spectral features were derived using Phase I measurements of the Pierre Auger Observatory and shown to be mostly declination independent~\cite{auger_prl2025_spectrum}.
Phase II Auger measurements are in agreement with the Phase I results, within uncertainties~\cite{icrc2025_diego_spectrum}.
The Telescope Array experiment reports measurements for the energy of the ankle, instep, and cutoff spectral features which generally agree with the Pierre Auger Observatory results within systematic uncertainties and accounting for the energy scale difference between the experiments~\cite{icrc2025_ta_spectrum}.
