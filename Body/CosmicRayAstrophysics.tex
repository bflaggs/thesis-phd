...
They were discovered in 1912 when Victor Hess, armed with his electroscope and a will to execute a daring idea, performed several hot-air balloon flights to study radiation in the atmosphere~\cite{victorhess_1912}.
Hess measured increasing levels of atmospheric radiation as his balloon increased up to \qty{5}{\kilo\meter} in altitude, leading him to hypothesize the existence of a ``radiation of cosmic origin'', to which he gave the name cosmic rays.
...
Cosmic rays span over 10 orders of magnitude in energy, starting from \qty[parse-numbers=false]{10^{9}}{\electronvolt} up to nearly \qty[parse-numbers=false]{10^{21}}{\electronvolt} and possibly beyond, with the highest-energy cosmic ray measured to have an energy of \qty{320}{\exa\electronvolt} by the Fly's Eye detector in 1991~\cite{flyseye_prl1995_omg}.
The flux of these cosmic particles arriving at Earth above an energy $E$, per unit area $A$, solid angle $\Omega$, and time $t$, is given by
...
Shown in~\Cref{fig:spectrum_measurements} is the differential flux of cosmic rays, i.e. the cosmic-ray energy spectrum, above nearly \qty[parse-numbers=false]{10^{15}}{\electronvolt} in energy as measured by various cosmic-ray experiments.
The differential flux is scaled by $E^{3}$ to highlight features in the cosmic-ray energy spectrum.
At these ultra-high energies, cosmic rays are extremely rare, with a flux of \qty{1}{\per\meter\squared\per\year} at roughly \qty{10}{\peta\electronvolt} and \qty{1}{\per\kilo\meter\squared\per\year} at nearly \qty{10}{\exa\electronvolt}.
Measuring ultra-high-energy cosmic rays with meaningful statistics therefore requires large observatories spanning several hundreds to thousands of kilometers squared in surface area.
...
\begin{itemize}
    ...
    \item \textit{Ankle}: a spectral hardening from $\gamma$\,=\,3.29 to $\gamma$\,=\,2.51 at an energy of \\\qty[parse-numbers=false]{(5.0\,$\pm$\,0.1\,$\pm$\,0.8)$\times$10^{18}}{\electronvolt}~\cite{auger_prd2020_spectrum, auger_prl2020_spectrum}.
    \item \textit{Instep}: a flattening of the $E^{3}$ weighted spectrum, resulting from a spectral index change of $\gamma$\,=\,2.51 to $\gamma$\,=\,3.05 at an energy of \qty[parse-numbers=false]{(1.3\,$\pm$\,0.1\,$\pm$\,0.2)$\times$10^{19}}{\electronvolt}~\cite{auger_prd2020_spectrum, auger_prl2020_spectrum}.
    \item \textit{Cutoff}: an extreme suppression in the flux, changing the spectral index from $\gamma$\,=\,3.05 to $\gamma$\,=\,5.1 at an energy of \qty[parse-numbers=false]{(4.6\,$\pm$\,0.3\,$\pm$\,0.6)$\times$10^{19}}{\electronvolt}~\cite{auger_prd2020_spectrum, auger_prl2020_spectrum}.
\end{itemize}
...
The second knee has also been measured using only the \qty{433}{\meter} spaced particle detector array of the Pierre Auger Observatory, yielding a cosmic-ray energy of \qty[parse-numbers=false]{(2.3\,$\pm$\,0.5)$\times$10^{17}} for the spectral break~\cite{icrc2023_gaby_spectrum}.
The above-stated energy transitions of the ankle, instep, and cutoff spectral features were derived using Phase I measurements of the Pierre Auger Observatory and shown to be mostly declination independent~\cite{auger_prl2020_spectrum}.
Phase II Auger measurements are in agreement with the Phase I results, within uncertainties~\cite{icrc2025_diego_spectrum}.
The Telescope Array experiment reports measurements for the energy of the ankle, instep, and cutoff spectral features which agree with the Pierre Auger Observatory results within systematic uncertainties FINDCITATIONS.
Therefore, the two largest cosmic-ray observatories in the world are in agreement.
