...
%As shown in Fig.~\ref{fig:IC_single_observables}, the proton-iron separation for certain air-shower observables, such as $\log(N_{\text{e}})$, is not heavily influenced by the observable's reconstruction uncertainty.
%Whereas other observables, such as $\log(N_{\mu})$, have a much higher dependence of the proton-iron discrimination power on the assumed observable reconstruction uncertainty.
