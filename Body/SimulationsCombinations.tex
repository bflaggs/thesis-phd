...
The evolution of the average $N_{\rm e, max}$ in bins true air-shower energy is shown in XXX for EPOS LHC-R simulations, while the evolution of the average values of all other observables in this analysis in bins of $N_{\rm e, max}$ is shown in XXX for the same hadronic model.
...
Note that the functional form of~\Cref{eq:scaling} works for the annulus based muon number at ground because the base-10 logarithm of these particle numbers is used in the analysis.
...
Scaling is different for each hadronic model because each model predicts different observable distributions, hence this correction to $m$ could be different for each hadronic model as well. 
