...
The annulus spanning \qtyrange{800}{850}{\meter} from the air-shower axis was chosen by maximizing the proton-iron separation power using the FOM metric in~\Cref{eq:fom} while simultaneously attempting to minimize the ratio of $N_{\mu}$ uncertainty-to-counts.
The proton-iron merit factors as a function of true air-shower energy for muon numbers within annuli of different spacings from the shower axis are shown in~\Cref{fig:muon_annuli}.
...
However, there are only small differences (approximately 0.1 or less) in the proton-iron separation power between the \qtyrange{950}{1000}{\meter} annulus and other annuli far from the shower axis.
...
Annuli farther from the shower axis, in general, exhibit a higher proton-iron mass separation power in most energy bins except at the highest energies, where the annulus \qtyrange{500}{550}{\meter} from the shower axis provides a larger separation than the \qtyrange{950}{1000}{\meter} annulus.
The chosen annulus of \qtyrange{800}{850}{\meter} lies between these extremes in the highest energy bins, balancing this compromise of mass sensitivity and statistics well across all energies and zenith angles.
Additionally,~\Cref{fig:muon_annuli_hadronic_model} shows the muon annulus proton-iron separation for QGSJETIII-01 and Sibyll 2.3e simulations.
...
As an additional crosscheck, a past study showed the optimum air-shower axis distance for proton-iron separation using vertical air showers (\qtyrange{0}{55}{\degree}) of \qty[parse-numbers=false]{10^{19.0}}{\electronvolt} in simulated energy is between \qtyrange{600}{800}{\meter}.
