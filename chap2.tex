...
The LNAs connect to a type-N coaxial cable that is buried and connected to the TAXI DAQ while each scintillator panel is also connected to TAXI via buried coaxial cables.
Power and communications for the DAQ comes from the Central Radio Station (CRS).
