...
With the described antenna positions, full reconstruction efficiency ($>$ 97\%) is reached at \SI{300}{\peta\electronvolt} for near-vertical air showers ($\theta <$ \SI{30}{\degree})~\cite{uhecr2024_verpoest}.
...
The readout of the radio data is triggered by the local station T1 trigger of the Auger SD tank Lety Jr.
Once the local station receives the 
